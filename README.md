...
After it's added to you project make sure at least the first delegate is executed in the same thread where process started. You should set checkers in Asynchronous continuations property group of the delegate on bpmn schema. Otherwise, stamps should be lost.  
